      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base">
            <Bell className="h-4 w-4 text-primary" /> Send to All Users
          </CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          ...
          {sent && (
            <div className="flex items-center gap-2 rounded-lg bg-primary/10 px-4 py-3 text-sm text-green-700 dark:bg-green-900/20 dark:text-green-400">
