    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-muted/40 py-16 md:py-24">
        <div className="container px-4 md:px-6 text-center space-y-4">
          ...
          <p className="max-w-[500px] mx-auto text-muted-foreground text-lg">
          ...
          <div className="grid gap-8 md:grid-cols-2 max-w-5xl mx-auto">
            ...
            <Card className="border-border">
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">Fill out the form and we'll get back to you as soon as possible.</p>
              </CardHeader>
              <CardContent>
              ...
              <Card className="border-border">
                <CardContent className="pt-6">
                  ...
                  <div className="flex gap-3">
                    {/* Facebook */}
                    <Button variant="outline" size="icon" className="hover:border-primary/30 hover:text-primary transition-colors">
