          ...
          <section className="cta-section py-16 md:py-24">
            <div className="cta-content max-w-6xl mx-auto px-5 text-center space-y-6 relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link href="/contact">
                  <Button size="lg" variant="outline" className="border-primary-foreground/20 bg-primary-foreground/10 text-primary-foreground hover:bg-primary-foreground/10 px-8">
                    Contact Us
                  </Button>
                </Link>
              </div>
